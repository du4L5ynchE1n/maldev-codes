...
int main() {
    ...
    void* executableBuffer = VirtualAlloc(NULL, sizeof(Rdata_RawData), MEM_COMMIT, PAGE_EXECUTE_READWRITE);
    ...
    memcpy(executableBuffer, Rdata_RawData, sizeof(Rdata_RawData));
